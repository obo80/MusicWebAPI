...
export function createAlbumCard(albumDto: AlbumDto): HTMLElement {
    ...
    if (tileSummary) {
        ...
        const ratingValue =
            (albumDto.averageRating !== null && albumDto.averageRating > 0) ? albumDto.averageRating.toString() : "Brak oceny";
...
export const displayAlbumsPage = async () => {
    const header = "Albumy";
